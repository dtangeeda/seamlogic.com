...
function MainMessage() {
	...
	<div className="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
		...
		<div className="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left">
			...
			<h1 className="my-4 text-5xl font-bold leading-tight">Our primary objective is to provide best solutions.</h1>
			<p className="leading-normal text-2xl mb-8">Specializes in Software Development, Consulting, Technology Staffing & Training.</p>
		...
		<div className="w-full md:w-3/5 py-6 text-center">
			<img className="w-full md:w-4/5 z-50" src={heroImg} alt='' />
		</div>
